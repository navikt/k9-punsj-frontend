...
- La til delt repo-oppsett med `AGENTS.md` og `.github/copilot-instructions.md`.
- La til repo-tilpassede agents, skills, prompts og file-specific instructions.
- La til delt `.vscode/mcp.json` og oppdaterte `copilot-setup-steps.yml` for GitHub coding agent.
...
- Strammet inn delt Copilot-guidance og reduserte overlapp mellom `AGENTS.md` og `.github/copilot-instructions.md`.
- La til `docs/CHANGELOG.md` som felles logg for merkbare repo- og oppsettendringer.

...
describe('Omsorgspengeutbetaling - ny søknad', () => {
    ...
    it.skip('Kan sende inn søknad for arbeidstaker', () => {
    ...
    it.skip('Kan sende inn søknad for frilanser', () => {
    ...
    it.skip('Kan sende inn søknad for selvstendig næringsdrivende', () => {
    ...
    it.skip('Innsending stoppes av validering', () => {
        cy.findByRole('button', { name: 'Send inn' }).click();

...
describe('PeriodInput', () => {
    ...
    it('should call onChange when a date is changed', () => {
        ...
        wrapper.find('DateInputNew').at(0).simulate('change', '2023-01-01');
        wrapper.find('DateInputNew').at(1).simulate('change', '2023-12-31');
    ...
    it('should call onBlur when a date input loses focus', () => {
        ...
        wrapper.find('DateInputNew').at(0).simulate('blur', '2023-01-01');
        wrapper.find('DateInputNew').at(1).simulate('blur', '2023-12-31');
    ...
    it('should disable the date inputs when disabled prop is true', () => {
        ...
        expect(wrapper.find('DateInputNew').at(0).prop('inputDisabled')).toBe(true);
        expect(wrapper.find('DateInputNew').at(1).prop('inputDisabled')).toBe(true);
    });
    ...
    it('should display error messages when provided', () => {
        ...
        expect(wrapper.find('DateInputNew').at(0).prop('errorMessage')).toBe('Invalid start date');
        expect(wrapper.find('DateInputNew').at(1).prop('errorMessage')).toBe('Invalid end date');
    });
});

...
describe('Fordeling: Flyt for pleiepenger', () => {
    ...
    it.skip('Viser riktig informasjon dersom dokumentet ikke gjelder pleiepenger', () => {
    ...
    it.skip('Viser riktig informasjon dersom dokumentet gjelder pleiepenger', () => {
    ...
    it.skip('Viser riktig informasjon dersom søkers fødselsnummer ikke stemmer', () => {
        fordeling.find({ name: 'identsjekk' }).simulate('change', { target: { value: 'nei' } });
        expect(fordeling.find('Input')).toHaveLength(1);
    });

    it.skip('Viser kopi av journalpost', () => {
        fordeling.find({ name: 'identsjekk' }).simulate('change', { target: { value: 'ja' } });
    ...
    it.skip('Kan ikke gå videre dersom man ikke fyllt in barn', () => {
        fordeling.setProps({

...
export const ApiPath = {
    ...
    PSB_K9SAK_PERIODER_OLD: `${BASE_PATHS.K9_PUNSJ}/pleiepenger-sykt-barn-soknad/k9sak/info`,
    PSB_K9SAK_PERIODER: `${BASE_PATHS.K9_PUNSJ}/pleiepenger-sykt-barn-soknad/k9sak/info/saksnummer`,

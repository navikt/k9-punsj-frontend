...
export class PunchFormOldComponent extends React.Component<
  IPunchFormProps,
...
export const PunchFormOld = injectIntl(
  connect(mapStateToProps, mapDispatchToProps)(PunchFormOldComponent)
);

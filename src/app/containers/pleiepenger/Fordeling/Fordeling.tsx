...
type IFordelingProps = WrappedComponentProps & IFordelingStateProps & IFordelingDispatchProps;
...
const Behandlingsknapp: React.FunctionComponent<BehandlingsknappProps> = ({
    ...
    return (
        <Hovedknapp onClick={() => omfordel(journalpost!.journalpostId, norskIdent)}>
            <FormattedMessage id="fordeling.knapp.bekreft" />
        </Hovedknapp>
    );
};
...
const FordelingComponent: React.FunctionComponent<IFordelingProps> = (props: IFordelingProps) => {
    ...
    const handleIdent2Blur = (event: any) => {
        props.setIdentAction(
            riktigIdentIJournalposten === JaNei.JA ? journalpostident || '' : sokersIdent,
            event.target.value,
                            ...
                            {gjelderPP === JaNei.NEI && (
                                <>
                                    ...
                                    <Input
                                        ...
                                        maxLength={11}
                                        feil={
                                            skalViseFeilmelding(identState.ident1) || identState.ident1.length <= 0
                                    ...
                                    <RadioPanelGruppe
                                        ...
                                        onChange={(event) => {
                                            props.setErIdent1Bekreftet(
                                                (event.target as HTMLInputElement).value === JaNei.JA ? true : false
                                            );
                                ...
                                <>
                                                    ...
                                                    <div className="dobbelSjekkIdent">
                                                        ...
                                                        <p>
                                                            <b>
                                                                {intlHelper(
                                                                    intl,
                                                                    'ident.identifikasjon.dobbelsjekkident'
                                                                )}
                                                            </b>
                                                        </p>
                                                    </div>
                                    ...
                                    {!(!!fordelingState.skalTilK9 || visSakstypeValg) && (
                                        <Knapp
                                            ...
                                            disabled={
                                                skalViseFeilmelding(barnetsIdent) ||
                                                (!barnetsIdent && !barnetHarIkkeFnr)
                                            }
                                        >
                        ...
                        {(!!fordelingState.skalTilK9 || visSakstypeValg) && (
                            <>
                                ...
                                {typeof fordelingState.sakstype !== 'undefined' &&
                                    fordelingState.sakstype === Sakstype.ANNET && (
                                        <AlertStripeInfo>
                                            {' '}
...
const mapDispatchToProps = (dispatch: any) => ({
    ...
    omfordel: (journalpostid: string, norskIdent: string) => dispatch(omfordelAction(journalpostid, norskIdent)),

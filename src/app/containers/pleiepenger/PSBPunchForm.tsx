...
import { IPSBSoknad, PSBSoknad, Tilleggsinformasjon } from '../../models/types/søknadTypes/PSBSoknad';
import { IUtenlandsOpphold } from '../../models/types/søknadTypes/UtenlandsOpphold';
import { SelvstendigNaeringsdrivendeOpptjening } from '../../models/types/søknadTypes/SelvstendigNaeringsdrivendeOpptjening';
import { IPSBSoknadUt, PSBSoknadUt } from '../../models/types/søknadTypes/PSBSoknadUt';
...
export class PunchFormComponent extends React.Component<IPunchFormProps, IPunchFormComponentState> {
    ...
    private initialPeriodeTimerMinutter = () => {
        const periode = this.getSoknadsperiode()[0];
        return new PeriodeMedTimerMinutter({
            periode,
            timer: 0,
            minutter: 0,
        });

...
import { formatDato, landkodeTilNavn, periodToFormattedString, sjekkPropertyEksistererOgIkkeErNull } from 'app/utils';
...
export default VisningAvPerioderSNPLSSoknadKvittering;

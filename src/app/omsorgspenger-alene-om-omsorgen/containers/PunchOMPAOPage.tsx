...
export interface IPunchOMPAOPageStateProps {
...
export interface IPunchOMPAOPageComponentProps {
    journalpostid?: string;
}

export interface IPunchOMPAOPageComponentState {
    søkerId: string;
    pleietrengendeId: string;
}

type IPunchOMPAOPageProps = WrappedComponentProps &
    RouteComponentProps &

...
const CheckCircleSvg: React.FunctionComponent<ICheckCircleSVGProps> = ({
                                                                       title,
                                                                       className,
                                                                   }) => (
    <svg

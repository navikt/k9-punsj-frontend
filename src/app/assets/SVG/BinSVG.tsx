...
const BinSvg: React.FunctionComponent<IBinSVGProps> = ({
                                                               title,
                                                               className,
                                                           }) => (
    <svg
        width="24" height="24" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg"
    >
        <title>{title}</title>

...
const FeilCircleSvg: React.FunctionComponent<IFeilCircleSVGProps> = ({
                                                                           title,
                                                                           className,
                                                                       }) => (
    <svg

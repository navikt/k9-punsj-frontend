...
import {IPunchOMPUTFormActionTypes} from '../actions/OMPUTPunchFormActions';
import {IPunchOMPUTFormState} from '../../types/PunchOMPUTFormState';

const initialState: IPunchOMPUTFormState = {
...
export function PunchOMPUTFormReducer(
    punchFormState: IPunchOMPUTFormState,
    action: IPunchOMPUTFormActionTypes
): IPunchOMPUTFormState {

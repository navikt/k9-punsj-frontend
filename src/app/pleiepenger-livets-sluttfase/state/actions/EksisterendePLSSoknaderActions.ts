...
type ICreatePLSSoknadActions = ICreatePLSSoknadRequestAction | ICreatePLSSoknadErrorAction | ICreatePLSSoknadSuccessAction;
...
export function setEksisterendePLSSoknaderAction(eksisterendeSoknaderSvar: IPLSSoknadSvar): ISetEksisterendePLSSoknaderAction {
    return {
        type: EksisterendePLSSoknaderActionKeys.EKSISTERENDE_PLS_SOKNADER_SET,
        eksisterendeSoknaderSvar,
    };
}
export function findEksisterendePLSSoknaderLoadingAction(isLoading: boolean): IFindEksisterendePLSSoknaderLoadingAction {
    return {
        type: EksisterendePLSSoknaderActionKeys.EKSISTERENDE_PLS_SOKNADER_LOAD,
        isLoading,
    };

...
import { OrgInfo } from 'app/components/brev/MottakerVelger';
import Fagsak from 'app/types/Fagsak';
import { get, getOrgInfo, post } from 'app/utils';
...
export const hentOrgInfo = (orgnummer: string, callback: (response: Response, data: OrgInfo[]) => void) =>
    getOrgInfo(orgnummer, callback);

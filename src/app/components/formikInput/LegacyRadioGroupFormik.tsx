...
// Formik adapter for legacy-compatible radios during migration to Aksel.
const LegacyRadioGroupFormik = ({ name, options, legend, retning = 'horisontal', ...props }: OwnProps) => {
...
export default LegacyRadioGroupFormik;
